  ...
  return (
    <div className="relative min-h-screen bg-black text-white flex flex-col items-center justify-center p-8">
      ...
      <div className="relative z-10 text-center mt-12">
        ...
        >
          <button
            className="bg-emerald-500 text-white px-6 py-3 rounded-lg text-lg"
      ...
      {open && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-gray-900 border border-emerald-500 text-white p-6 rounded-lg">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="mt-4 bg-emerald-500 text-white px-6 py-3 rounded-lg w-full"
              >
                Apply Now
              </button>
            </form>
